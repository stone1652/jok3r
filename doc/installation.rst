...
.. code-block:: console
    ...
    sudo docker run -i -t --name jok3r-container -w /root/jok3r --net=host stone1652/jok3r
...
.. code-block:: console
    ...
    wget https://raw.githubusercontent.com/stone1652/jok3r/master/docker/Dockerfile
...
.. note::
    ...
    * Use the following command to run the container:
    ...
    .. code-block:: console
        ...
        sudo docker run -i -t --name jok3r-container -w /root/jok3r -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix --net=host stone1652/jok3r
