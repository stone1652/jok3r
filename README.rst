...
.. image:: https://img.shields.io/microbadger/image-size/stone1652/jok3r.svg
    :target: https://hub.docker.com/r/stone1652/jok3r/
    :alt: Docker Size

.. image:: https://img.shields.io/docker/cloud/build/stone1652/jok3r.svg
...
**Many tests are going on: see https://github.com/stone1652/jok3r/blob/master/tests/TESTS.rst. 
...
.. image:: https://raw.githubusercontent.com/stone1652/jok3r/master/pictures/docker-logo.png

A Docker image is available on Docker Hub and automatically re-built at each update: 
https://hub.docker.com/r/stone1652/jok3r/. It is initially based on official Kali
Linux Docker image (kalilinux/kali-linux-docker).

.. image:: https://images.microbadger.com/badges/image/stone1652/jok3r.svg
   :target: https://microbadger.com/images/stone1652/jok3r
...
1. **Pull Jok3r Docker Image:**
    ...
    .. code-block:: console
        ...
        sudo docker pull stone1652/jok3r

2. **Run fresh Docker container:**

    .. code-block:: console

        sudo docker run -i -t --name jok3r-container -w /root/jok3r -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix --shm-size 2g --net=host stone1652/jok3r
...
.. code-block:: console
    ...
    sudo docker pull stone1652/jok3r
    sudo docker run -i -t --name jok3r-container-updated -w /root/jok3r -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix --shm-size 2g --net=host stone1652/jok3r
...
Changelog
=============
See `Changelog <https://github.com/stone1652/jok3r/blob/master/CHANGELOG.rst>`_
